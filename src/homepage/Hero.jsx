...
const Hero = () => {
  return (
    <div className='flex flex-col-reverse lg:flex-row gap-2 px-6 md:px-16 lg:px-36 justify-center'>
        <div className='lg:w-1/2 w-full'>
            <h1 className='font-bold hero-text text-3xl  md:mt-16 mt-4 lg:mt-24'>Let's Elevate Your Financial Journey to Greater Heights!</h1>
            <p className='text-xl mt-2 md:font-semibold'>Welcome to DRAG, your all-in-one solution for effortless financial management with empowered savings.</p>
